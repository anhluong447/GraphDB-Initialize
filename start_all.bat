...
echo [1/3] Starting Docker databases (Neo4j ^& Chroma)...
...
:: 3. Start Backend API
echo [2/3] Starting Backend API (FastAPI) in a new window...
...
echo [3/3] Starting Frontend Dashboard (Vite) in a new window...
...
:: 5. Automatically open web dashboard in default browser
timeout /t 3 > nul
