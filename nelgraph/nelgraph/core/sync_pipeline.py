import os
import time
from nelgraph.config import CODEBASE_PATH, IGNORE_DIRS
...
def run_incremental_sync():
    ...
    if not acquire_lock("incremental_sync"):
        print("[Sync] Another sync/hook is running. Skipping to avoid conflict.")
        return
    ...
    try:
        ...
        print("\n[2/6] Ensuring databases are running...")
        _start_docker()
        ...
        from nelgraph.embeddings.chroma_client import collection
        for file_path in all_affected_files:
            try:
        ...
        if modified_files:
            ...
            if parsed:
                ...
                from nelgraph.embeddings.chroma_client import embed_nodes_for_files
