...
def step_parse_codebase(codebase_path: str) -> dict:
    ...
    from nelgraph.parsers.ast_parser import parse_codebase
    from nelgraph.parsers.doc_parser import parse_docs
...
def step_build_graph(parsed_files: list, commits: list):
    ...
    from nelgraph.graph.builder import build_file_nodes, build_git_nodes
...
def step_link_commits(commits: list, parsed_files: list, codebase_path: str):
    ...
    from nelgraph.graph.builder import link_commits_to_functions
...
def step_extract_semantics(parsed_files: list, docs: list):
    ...
    from nelgraph.graph.neo4j_client import get_client
    from nelgraph.graph.builder import build_semantic_nodes
    from nelgraph.extractors.llm_extractor import batch_extract
...
def step_embed_nodes():
    ...
    from nelgraph.embeddings.chroma_client import embed_all_nodes
    embed_all_nodes()
