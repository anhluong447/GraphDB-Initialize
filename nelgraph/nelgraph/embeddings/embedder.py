import openai
from nelgraph.config import OPENROUTER_API_KEY, OPENROUTER_BASE_URL, EMBEDDING_MODEL, EMBEDDING_DIMENSIONS
...
def _get_openai_client():
    ...
    if _openai_client is None:
        from nelgraph.config import OPENROUTER_API_KEY, OPENROUTER_BASE_URL
...
def build_node_text(node_record: dict, relations_dict: dict = None) -> str:
    ...
    if relations_dict is not None:
        ...
        # Get outgoing neighbors from nelgraph.graph
        result = client.run("""
