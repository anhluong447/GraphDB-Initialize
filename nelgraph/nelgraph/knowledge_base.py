...
Usage:
    from nelgraph.knowledge_base import get_function_context, get_snapshot, get_changes, mark_tested
"""
...
def _check_and_auto_sync():
    ...
    try:
        ...
        from nelgraph.core.init_pipeline import _load_sync_state
...
def run_init(codebase_path: str = None):
    ...
    from nelgraph.initialize_graph import run_full_init
    run_full_init()
